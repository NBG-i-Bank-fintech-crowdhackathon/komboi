...
update investors set inv_weight=10
where user_id = 'f3872015-ee21-4c33-9bc2-e1ac80073665';
...
insert into projects  (project_id, state, creating_user_id,
project_name, project_description, required_amount, current_amount)
values ('67d647d7-94e0-449c-8d92-fcce5eda7170', 'approved',
'f3872015-ee21-4c33-9bc2-e1ac80073665',
'The big plan', 'Crush your enemies. See them driven before you. Hear the lamentations of their women', 13000.00, 26000.00);
...
update projects set estimated_risk_factor='extreme' where project_id='67d647d7-94e0-449c-8d92-fcce5eda7170';


create table project_investor_credibility (
       project_id UUID NOT NULL,
       required_credibility real NOT NULL,
       -- this field is an abomination. It should not be stored here,
       -- but rather calculated as a sum. However for mock purposes
       -- we store it here.
...
insert into project_investor_credibility
(project_id, required_credibility, current_credibility)
VALUES ('67d647d7-94e0-449c-8d92-fcce5eda7170', 120.0, 180.0);
...
insert into triumphs (user_id, date_unlocked, triumph_type,
description, award)
VALUES('f3872015-ee21-4c33-9bc2-e1ac80073665', '2016-04-18 01:03:33+00',
'Credible Source', 'Investor credibility of +10!', '30% discount on a restaurant of your choice');



CREATE TABLE investor_greenlight (
       user_id UUID NOT NULL,
       project_id UUID NOT NULL,
       FOREIGN KEY (user_id) REFERENCES investors(user_id),
       FOREIGN KEY (project_id) REFERENCES projects(project_id),
...
insert into investor_greenlight (user_id, project_id)
values ('f3872015-ee21-4c33-9bc2-e1ac80073665', 'ff8808d5-7bfe-458a-b5f5-e7b1387a9f91');
